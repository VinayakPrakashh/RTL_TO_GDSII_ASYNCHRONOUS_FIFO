...
# Generated on: Tue Mar 04 16:10:18 IST 2025 (Tue Mar 04 10:40:18 UTC 2025)
...
set logfile intermediate2final.lec.log ;# user can modify this name for succeeding runs
...
set_verification_information fv_map_fifo_top_incrementalv_db

read_implementation_information fv/fifo_top -golden fv_map -revised fifo_top_incrementalv
...
add_search_path /run/media/user1/c2s/cadence/install/SCL_PDK/scl180/stdcell/fs120/4M1IL/liberty/lib_flow_ss /run/media/user1/c2s/cadence/install/SCL_PDK/scl180/stdcell/fs120/4M1IL/liberty/lib_flow_ff -library -both
...
read_design -verilog95   -golden -lastmod -noelab ./fifo_top_incremental.v
elaborate_design -golden -root {fifo_top}

read_design -verilog95   -revised -lastmod -noelab ./fifo_postRoute_withoutPG.v
elaborate_design -revised -root {fifo_top}

#add_name_alias fv/fifo_top/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/fifo_top/fifo_top_incrementalv.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.fifo_top.fv_map.fifo_top_incrementalv.tcl -class noneq -tclmode -replace
...
report_test_vector -noneq > noneq.test_vector.fifo_top.fv_map.fifo_top_incrementalv.rpt
