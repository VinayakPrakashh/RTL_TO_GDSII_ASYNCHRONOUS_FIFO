...
// Generated on: Feb 20 2025 10:59:06 IST (Feb 20 2025 05:29:06 UTC)
...
module fifo_empty(rd_clk, rd_en, rd_rst, wr_ptr_addr_sync, empty,
  ...
  inv0d1 g186(.I (n_16), .ZN (rd_addr_bin_next[4]));
  ...
  inv0d0 g198(.I (rd_addr_grey[4]), .ZN (n_10));
  dfprb2 empty_r_reg(.SDN (rd_rst), .CP (rd_clk), .D (n_9), .Q (empty),
       .QN (UNCONNECTED));
  ...
  dfcrq1 \rd_addr_bin_r_reg[4] (.CDN (rd_rst), .CP (rd_clk), .D
       (rd_addr_bin_next[4]), .Q (rd_addr_grey[4]));
...
module fifo_full(wr_clk, wr_en, wr_rst, rd_ptr_addr_sync, full,
  ...
  inv0d1 g214(.I (n_15), .ZN (wr_addr_binary_next[4]));
