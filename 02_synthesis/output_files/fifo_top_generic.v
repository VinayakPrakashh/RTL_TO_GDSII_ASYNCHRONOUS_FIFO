...
// Generated on: Feb 20 2025 10:59:01 IST (Feb 20 2025 05:29:01 UTC)
...
module reset_sync_43(clk, rst, rst_sync);
  ...
  wire clk, rst;
  wire rst_sync;
  wire n_4, rst_sync_reg_8;
  not g1 (n_4, rst);
  CDN_flop rst_sync_reg(.clk (clk), .d (rst_sync_reg_8), .sena (1'b1),
       .aclr (n_4), .apre (1'b0), .srl (1'b0), .srd (1'b0), .q
       (rst_sync));
  CDN_flop rst_sync_reg_reg(.clk (clk), .d (1'b1), .sena (1'b1), .aclr
       (n_4), .apre (1'b0), .srl (1'b1), .srd (1'b1), .q
       (rst_sync_reg_8));
endmodule
