...
# DVE full session
# Saved on Mon Feb 24 15:20:36 2025
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state maximized -rect {{0 37} {1365 740}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 190} {height 438} {dock_state left} {dock_on_new_line true} {child_hier_colhier 132} {child_hier_coltype 64} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 105} {height 438} {dock_state left} {dock_on_new_line true} {child_data_colvariable 123} {child_data_colvalue 23} {child_data_coltype 106} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1365} {height 158} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 155} {child_wave_right 908} {child_wave_colname 120} {child_wave_colvalue 30} {child_wave_col1 0} {child_wave_col2 1}}
...
# Restore C1 time
gui_set_time -C1_only 82331809000
...
gui_view_scroll -id ${Hier.1} -vertical -set 3578
...
gui_wv_zoom_timerange -id ${Wave.1} 82331808852 82331809148
...
gui_marker_move -id ${Wave.1} {C1} 82331809000
