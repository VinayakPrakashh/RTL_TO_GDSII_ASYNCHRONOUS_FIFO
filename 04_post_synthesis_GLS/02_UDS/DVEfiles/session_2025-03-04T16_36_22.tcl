...
# DVE full session
# Saved on Tue Mar 4 16:36:22 2025
# Designs open: 1
#   Sim: /run/media/user1/c2s/S5_training_batch2/VINAYAK/04_post_synthesis_GLS/02_UDS/test
# Toplevel windows open: 1
# 	TopLevel.1
#   Source.1: fifo_tb.fifo_inst.m.\mem_reg[15][6] 
#   Wave.1: 24 signals
#   Group count = 1
...
#<Session mode="Full" path="/run/media/user1/c2s/S5_training_batch2/VINAYAK/04_post_synthesis_GLS/02_UDS/DVEfiles/session.tcl" type="Debug">
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 168} {height 567} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 47} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 208} {height 567} {dock_state left} {dock_on_new_line true} {child_data_colvariable 123} {child_data_colvalue 23} {child_data_coltype 106} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 173]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1534
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 173
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1533} {height 172} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 289} {child_wave_right 861} {child_wave_colname 181} {child_wave_colvalue 104} {child_wave_col1 0} {child_wave_col2 1}}
...
if { ![gui_is_db_opened -db {/run/media/user1/c2s/S5_training_batch2/VINAYAK/04_post_synthesis_GLS/02_UDS/test}] } {
gui_sim_run Ucli -exe test -args { -ucligui} -dir /run/media/user1/c2s/S5_training_batch2/VINAYAK/04_post_synthesis_GLS/02_UDS -nosource
}
}
...
gui_view_scroll -id ${Hier.1} -vertical -set 6043
...
gui_open_source -id ${Source.1}  -replace -active {fifo_tb.fifo_inst.m.\mem_reg[15][6] } /run/media/user1/c2s/S5_training_batch2/VINAYAK/04_post_synthesis_GLS/02_UDS/tsl18fs120_scl.v
gui_view_scroll -id ${Source.1} -vertical -set 71355
...
gui_wv_zoom_timerange -id ${Wave.1} 31778862 31779142
...
gui_marker_move -id ${Wave.1} {C1} 31779002
