...
# DVE full session
# Saved on Tue Mar 4 16:38:07 2025
# Designs open: 1
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 167} {height 567} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 47} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 207} {height 567} {dock_state left} {dock_on_new_line true} {child_data_colvariable 123} {child_data_colvalue 23} {child_data_coltype 106} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1532} {height 171} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 289} {child_wave_right 862} {child_wave_colname 181} {child_wave_colvalue 104} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_open_source -id ${Source.1}  -replace -active fifo_tb /run/media/user1/c2s/S5_training_batch2/VINAYAK/04_post_synthesis_GLS/02_UDS/fifo_tb_pad.v
...
gui_wv_zoom_timerange -id ${Wave.1} 94604860 94605140
...
gui_marker_move -id ${Wave.1} {C1} 94605000
