...
# DVE full session
# Saved on Tue Feb 25 12:37:19 2025
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{30 54} {1563 892}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 175} {height 572} {dock_state left} {dock_on_new_line true} {child_hier_colhier 132} {child_hier_coltype 64} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 105} {height 572} {dock_state left} {dock_on_new_line true} {child_data_colvariable 123} {child_data_colvalue 23} {child_data_coltype 106} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1533} {height 167} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 210} {child_wave_right 1036} {child_wave_colname 154} {child_wave_colvalue 52} {child_wave_col1 0} {child_wave_col2 1}}
...
# Restore C1 time
gui_set_time -C1_only 83594467000
...
gui_view_scroll -id ${Hier.1} -vertical -set 3378
...
gui_wv_zoom_timerange -id ${Wave.1} 83594466831 83594467169
...
gui_marker_move -id ${Wave.1} {C1} 83594467000
