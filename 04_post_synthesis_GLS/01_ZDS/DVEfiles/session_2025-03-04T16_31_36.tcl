...
# DVE full session
# Saved on Tue Mar 4 16:31:36 2025
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{8 31} {1544 872}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 171} {height 567} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 47} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 211} {height 567} {dock_state left} {dock_on_new_line true} {child_data_colvariable 123} {child_data_colvalue 23} {child_data_coltype 106} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1536} {height 175} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 289} {child_wave_right 858} {child_wave_colname 181} {child_wave_colvalue 104} {child_wave_col1 0} {child_wave_col2 1}}
...
# Restore C1 time
gui_set_time -C1_only 132825000
...
gui_wv_zoom_timerange -id ${Wave.1} 124523445 132825008
...
gui_marker_move -id ${Wave.1} {C1} 132825000
