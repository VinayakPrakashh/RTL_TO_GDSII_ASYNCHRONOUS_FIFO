...
# DVE full session
# Saved on Thu Feb 20 11:46:18 2025
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{8 31} {1710 915}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 607
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 176} {height 607} {dock_state left} {dock_on_new_line true} {child_data_colvariable 112} {child_data_colvalue 12} {child_data_coltype 52} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1702} {height 178} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 286} {child_wave_right 1128} {child_wave_colname 211} {child_wave_colvalue 70} {child_wave_col1 0} {child_wave_col2 1}}
...
catch { gui_list_select -id ${Data.1} {fifo_tb.fifo_inst.wr_data }}
...
gui_wv_zoom_timerange -id ${Wave.1} 8544 8908
gui_list_add_group -id ${Wave.1} -after {New Group} {fifo_inst}
gui_list_select -id ${Wave.1} {fifo_tb.fifo_inst.rd_rst_sync }
...
gui_marker_move -id ${Wave.1} {C1} 8861
