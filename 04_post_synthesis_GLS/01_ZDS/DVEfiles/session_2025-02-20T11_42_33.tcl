...
# DVE full session
# Saved on Thu Feb 20 11:42:33 2025
# Designs open: 1
#   Sim: /run/media/user1/c2s/S5_training_batch2/Vinayak3/04_post_synthesis_GLS/01_ZDS/test
# Toplevel windows open: 1
# 	TopLevel.1
#   Schematic.1: .
#   Schematic.2: fifo_tb.fifo_inst
#   Wave.1: 24 signals
#   Source.1: fifo_tb
#   Group count = 1
...
#<Session mode="Full" path="/run/media/user1/c2s/S5_training_batch2/Vinayak3/04_post_synthesis_GLS/01_ZDS/DVEfiles/session.tcl" type="Debug">

gui_set_loading_session_type Post
gui_continuetime_set -value 1ps
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{8 31} {1711 916}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 105} {height 607} {dock_state left} {dock_on_new_line true} {child_hier_colhier 256} {child_hier_coltype 54} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 177} {height 607} {dock_state left} {dock_on_new_line true} {child_data_colvariable 112} {child_data_colvalue 12} {child_data_coltype 52} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${DriverLoad.1} {{left 0} {top 0} {width 1431} {height 179} {dock_state bottom} {dock_on_new_line false}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 135} {child_wave_right 1279} {child_wave_colname 90} {child_wave_colvalue 41} {child_wave_col1 0} {child_wave_col2 1}}
...
if { ![gui_is_db_opened -db {/run/media/user1/c2s/S5_training_batch2/Vinayak3/04_post_synthesis_GLS/01_ZDS/test}] } {
gui_sim_run Ucli -exe test -args { -ucligui} -dir /run/media/user1/c2s/S5_training_batch2/Vinayak3/04_post_synthesis_GLS/01_ZDS -nosource
}
}
...
gui_open_source -id ${Source.1}  -replace -active fifo_tb /run/media/user1/c2s/S5_training_batch2/Vinayak3/04_post_synthesis_GLS/01_ZDS/fifo_tb_pad.v
...
gui_sch_show -window ${Schematic.2} -name fifo_tb.fifo_inst
gui_show_pin_value_annotate [gui_window_hier_name -window ${Schematic.2}]
gui_zoom -window ${Schematic.2} -rect { {-25054 -90470} {186824 5094} }
...
gui_wv_zoom_timerange -id ${Wave.1} 0 0
gui_list_add_group -id ${Wave.1} -after {New Group} {fifo_tb}
gui_list_select -id ${Wave.1} {fifo_tb.rd_entmp }
...
gui_get_drivers -session -id ${DriverLoad.1} -signal fifo_tb.rd_entmp -time 0 -starttime 0
