...
# Generated on: Thu Feb 20 10:59:05 IST 2025 (Thu Feb 20 05:29:05 UTC 2025)
...
set logfile fv/fifo_top/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/fifo_top -revised fv_map
...
add_search_path /run/media/user1/c2s/S5_training_batch2/Vinayak3/02_synthesis/RTL_source -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /run/media/user1/c2s/S5_training_batch2/Vinayak3/02_synthesis/RTL_source/fifo_pad.v
elaborate_design -golden -root {fifo_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/fifo_top/fv_map.v.gz
...
#add_name_alias fv/fifo_top/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.fifo_top.rtl.fv_map.tcl -class noneq -tclmode -replace
...
report_test_vector -noneq > noneq.test_vector.fifo_top.rtl.fv_map.rpt
