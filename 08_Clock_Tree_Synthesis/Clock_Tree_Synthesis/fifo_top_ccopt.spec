...
#  Generated on:      Tue Mar  4 18:15:51 2025
#  Design:            fifo_top
...
#   write_clk (period 15.000ns) in timing_config all([/run/media/user1/c2s/S5_training_batch2/VINAYAK/07_Placement/Placement/fifo_top.enc.dat/mmmc/modes/all/all.sdc])
...
#   read_clk (period 30.000ns) in timing_config all([/run/media/user1/c2s/S5_training_batch2/VINAYAK/07_Placement/Placement/fifo_top.enc.dat/mmmc/modes/all/all.sdc])
...
# Skew group to balance non generated clock:read_clk in timing_config:all (sdc /run/media/user1/c2s/S5_training_batch2/VINAYAK/07_Placement/Placement/fifo_top.enc.dat/mmmc/modes/all/all.sdc)
...
# Skew group to balance non generated clock:write_clk in timing_config:all (sdc /run/media/user1/c2s/S5_training_batch2/VINAYAK/07_Placement/Placement/fifo_top.enc.dat/mmmc/modes/all/all.sdc)
