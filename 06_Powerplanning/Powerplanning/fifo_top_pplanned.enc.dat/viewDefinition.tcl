...
create_op_cond -name op_cond_best -library_file ${::IMEX::libVar}/mmmc/tsl18fs120_scl_ff.lib -P 10 -V 10 -T 10
create_op_cond -name op_cond_worst -library_file ${::IMEX::libVar}/mmmc/tsl18fs120_scl_ss.lib -P 10 -V 10 -T 10
...
create_constraint_mode -name all\
   -sdc_files\
    [list ${::IMEX::libVar}/mmmc/fifo_top_incremental.sdc]
