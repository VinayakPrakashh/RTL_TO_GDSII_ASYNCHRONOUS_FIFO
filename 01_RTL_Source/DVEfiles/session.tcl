...
# DVE full session
# Saved on Thu Feb 20 10:16:43 2025
# Designs open: 1
#   Sim: /run/media/user1/c2s/S5_training_batch2/Vinayak3/01_RTL_source/test
# Toplevel windows open: 1
# 	TopLevel.1
#   Source.1: fifo_tb
#   Wave.1: 18 signals
#   Group count = 1
#   Group fifo_inst signal count = 18
...
#<Session mode="Full" path="/run/media/user1/c2s/S5_training_batch2/Vinayak3/01_RTL_source/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{8 31} {1713 918}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 105} {height 683} {dock_state left} {dock_on_new_line true} {child_hier_colhier 256} {child_hier_coltype 54} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
set DLPane.1 [gui_create_window -type DLPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 180]
catch { set Data.1 [gui_share_window -id ${DLPane.1} -type Data] }
gui_set_window_pref_key -window ${DLPane.1} -key dock_width -value_type integer -value 180
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 684
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 179} {height 683} {dock_state left} {dock_on_new_line true} {child_data_colvariable 112} {child_data_colvalue 12} {child_data_coltype 52} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1705} {height 105} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 152} {child_wave_right 1262} {child_wave_colname 124} {child_wave_colvalue 24} {child_wave_col1 0} {child_wave_col2 1}}
...
if { ![gui_is_db_opened -db {/run/media/user1/c2s/S5_training_batch2/Vinayak3/01_RTL_source/test}] } {
gui_sim_run Ucli -exe test -args { -ucligui} -dir /run/media/user1/c2s/S5_training_batch2/Vinayak3/01_RTL_source -nosource
}
}
...
gui_open_source -id ${Source.1}  -replace -active fifo_tb /run/media/user1/c2s/S5_training_batch2/Vinayak3/01_RTL_source/fifo_tb.v
...
gui_wv_zoom_timerange -id ${Wave.1} 4868643 11982590
...
gui_marker_move -id ${Wave.1} {C1} 31900
