...
# DVE full session
# Saved on Tue Mar 4 15:56:45 2025
# Designs open: 1
#   Sim: /run/media/user1/c2s/S5_training_batch2/VINAYAK/01_RTL_source/test
...
#<Session mode="Full" path="/run/media/user1/c2s/S5_training_batch2/VINAYAK/01_RTL_source/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{8 31} {1545 873}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 172} {height 567} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 47} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 212} {height 567} {dock_state left} {dock_on_new_line true} {child_data_colvariable 123} {child_data_colvalue 23} {child_data_coltype 106} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 177]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1538
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 177
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1537} {height 176} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 289} {child_wave_right 857} {child_wave_colname 181} {child_wave_colvalue 104} {child_wave_col1 0} {child_wave_col2 1}}
...
if { ![gui_is_db_opened -db {/run/media/user1/c2s/S5_training_batch2/VINAYAK/01_RTL_source/test}] } {
gui_sim_run Ucli -exe test -args { -ucligui} -dir /run/media/user1/c2s/S5_training_batch2/VINAYAK/01_RTL_source -nosource
}
}
...
gui_open_source -id ${Source.1}  -replace -active fifo_tb /run/media/user1/c2s/S5_training_batch2/VINAYAK/01_RTL_source/fifo_tb.v
...
gui_wv_zoom_timerange -id ${Wave.1} 0 241949
...
gui_marker_move -id ${Wave.1} {C1} 15484700
